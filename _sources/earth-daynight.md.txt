...
The following codes for *rru* are supported. The sizes refers to the earth_day version
...
1. Black Marble: [<https://earthobservatory.nasa.gov/features/NightLights/page3.php>].
