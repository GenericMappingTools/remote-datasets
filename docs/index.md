...
[remote file mechanism](https://docs.generic-mapping-tools.org/dev/datasets/remote-data.html).

Information about the GMT data server and mirrors can be found on the
[GMT organization website](https://www.generic-mapping-tools.org/mirrors/).
...
:::{toctree}
:hidden:
:caption: Other Celestial Bodies
